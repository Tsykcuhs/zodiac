...
function horoscope() {
	...
	for(i = 0; i < zodiac.length; i++) {
		if(sign === zodiac[i].sign) {
			...
			document.getElementById("yourHoroscope").innerHTML = "Attributes associated with your sign are " + zodiac[i].fortune
			return
		} else {
			document.getElementById("yourSign").innerHTML = "I'm not familar with that sign."
